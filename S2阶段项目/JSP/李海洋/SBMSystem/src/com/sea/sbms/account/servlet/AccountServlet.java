package com.sea.sbms.account.servlet;
...
import com.sea.sbms.account.service.impl.AccountServiceImpl;
import com.sea.sbms.common.bean.PageBean;
import com.sea.sbms.common.service.CommonService;
import com.sea.sbms.common.service.impl.CommonServiceImpl;
...
public class AccountServlet extends HttpServlet {
	...
	private void updateAccount(HttpServletRequest request,
		...
		int row = aService.updateAccount(Integer.parseInt(accountId),
	...
	private void addAccount(HttpServletRequest request,
		...
		int row = aService.addAccount(goods, Integer.parseInt(providerId),
				Integer.parseInt(isPayed), Integer.parseInt(businessNum));

		if (row > 0) {
			// 添加成功
			RequestDispatcher requestDispatcher = request
					.getRequestDispatcher("goods?cmd=updateGoods");
