 ...
 * 
 */
package com.sea.sbms.goods.dao.impl;
...
import com.sea.sbms.goods.dao.GoodsDao;
...
public class GoodsDaoImpl implements GoodsDao {
	...
	public Goods getGoodsInfoByName(String goodsName) {
		...
		try {
			...
			if (rs.next()) {
				goods = new Goods(rs.getInt("goodsId"), goodsName,
						rs.getInt("goodsNum"), rs.getFloat("goodsPrice"),
						rs.getString("goodsUnit"), rs.getString("goodsIntro"));
			}
