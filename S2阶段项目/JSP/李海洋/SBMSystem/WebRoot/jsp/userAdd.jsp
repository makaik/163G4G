...
<body>
	<div class="main">
		...
		<form id="form1" name="form1" method="post" action="user?cmd=addUser"
				...
				<table class="box">
					...
					<tr>
						...
						<td><textarea name="address" id="address" class="text"
								cols="45" rows="5"></textarea><font color="red">*</font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="pic" name="pic" class="text">
							<font color="red">*</font>
						</td>
					</tr>
				</table>
			...
			<div class="buttons">
				<input type="submit" name="button" id="button" value="添加用户" class="input-button" /> 
